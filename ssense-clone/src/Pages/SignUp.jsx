  ...
  export const SignUp = () => {
    ...
    return (
     ...
     <Box width="50%" m="auto 150px auto auto" pb="120px" pt="60px">   
         ...
         <Text fontSize="12px" m="1rem"> CREATE AN ACCOUNT</Text>

        <FormControl>
         
          {/* Email...................... */}
          <FormLabel htmlFor="email" fontSize="14px" fontWeight="200">Email</FormLabel>
          <Input value={user.email}   onChange={(e) => {
                handleChange(e);
              }} height="30px"  borderRadius="0" borderColor="black" width="60%" name="email" type="email" placeholder='Enter Email ID'/>
        <Spacer/>
          {/* Password ................................ */}
          <br></br>
          <FormLabel htmlFor="text" fontSize="14px" fontWeight="200">Password</FormLabel>
          <Input
             height="30px"
             borderRadius="0" borderColor="black" width="60%"
              type="password"
              name="password"
